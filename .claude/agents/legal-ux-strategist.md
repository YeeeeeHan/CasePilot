...
1. **Show provenance**: Where did this image come from? (hover to see metadata)
2. **Diff before commit**: Show what changed before auto-renumbering
3. **Undo everything**: One-click revert for any AI action
4. **Compile errors**: Catch mistakes before filing, not after
